# -*- coding: utf-8 -*-
"""
Created on Sun Apr 24 09:50:20 2022

@author: Diego Sanmiguel
"""

cancion_pollito_pio = """En la radio, hay un pollito
...
palabra_buscada = "pío"
veces_palabra_buscada = cancion_pollito_pio.count(palabra_buscada)
cantidad_palabras = len(cancion_pollito_pio.split())

print("-"*50)
print("la cación 'del pollito pio' tiene '{}' palabras".format(cantidad_palabras))
print("-"*50)
print("la palabra '{}' está '{}' veces en la cancion del pollito pío".format(palabra_buscada, veces_palabra_buscada))
print("-"*50)
